...
The main objective of this project is to ensure that the application’s
core business flows, role-based access, and data consistency work as expected.
...
Scenario-based and test case-based summaries are generated automatically
from executed test cases to provide accurate test results.
...
## Author
**Josia Jounry Julius Nanlohy** **josia hanya iseng**
